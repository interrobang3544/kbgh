  ...
  .then((response) => {
    ...
    <div class="main-box-title">${CharacterName}</div>
      <div class="main-box-content">
        ...
        <a href="https://loawa.com/char/${CharacterName}" target="_blank"><div class="loawa_link"><img src="/images/loawa.png"></div></a>
        <a href="https://lostark.game.onstove.com/Profile/Character/${CharacterName}" target="_blank"><div class="lostark_link"><img src="/images/lostark.png"></div></a>
      </div>
    </div>
